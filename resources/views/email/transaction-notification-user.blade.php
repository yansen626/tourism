...
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta name="viewport" content="initial-scale=1.0"><meta name="format-detection" content="telephone=no"><title>MOSAICO Responsive Email Designer</title><style type="text/css">.socialLinks {font-size: 6px;}
        ...
        #ko_footerBlock_2 .links-color a:visited, #ko_footerBlock_2 .links-color a:hover {color: #ccc;color: #ccc;text-decoration: underline;}</style></head><body style="margin: 0;padding: 0;background-color: #3f3f3f;color: #919191;" vlink="#cccccc" text="#919191" bgcolor="#3f3f3f" alink="#cccccc">
...
<center>
    ...
    <table class="vb-outer" style="background-color: #bfbfbf;" id="ko_logoBlock_6" width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#bfbfbf"><tbody><tr><td class="vb-outer" style="padding-left: 9px;padding-right: 9px;background-color: #bfbfbf;" valign="top" bgcolor="#bfbfbf" align="center">

                <!--[if (gte mso 9)|(lte ie 8)]><table align="center" border="0" cellspacing="0" cellpadding="0" width="570"><tr><td align="center" valign="top"><![endif]-->
                <div class="oldwebkit" style="max-width: 570px;">
                    <table style="border-collapse: separate;border-spacing: 18px;padding-left: 0;padding-right: 0;width: 100%;max-width: 570px;" class="vb-container fullpad" width="570" cellspacing="18" cellpadding="0" border="0"><tbody><tr><td valign="top" align="center">
                                ...
                                <div class="mobile-full" style="display: inline-block; max-width: 166px; vertical-align: top; width: 100%;">
                                    <img alt="" style="border: 0px;display: block;width: 100%;max-width: 166px;" src="https://mosaico.io/srv/f-dtn0k95/img?src=https%3A%2F%2Fmosaico.io%2Ffiles%2Fdtn0k95%2Fabout_img1.jpg&amp;method=resize&amp;params=166%2Cnull" width="166" vspace="0" hspace="0" border="0"></div>
        ...
        </tr></tbody></table><table class="vb-outer" style="background-color: #bfbfbf;" id="ko_textBlock_4" width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#bfbfbf"><tbody><tr><td class="vb-outer" style="padding-left: 9px;padding-right: 9px;background-color: #bfbfbf;" valign="top" bgcolor="#bfbfbf" align="center">
