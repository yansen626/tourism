...
<div class="col-md-2" style="min-height: 100%;background-color: #ffc801;padding-top: 3%;">
    <div class="col-md-5">
    ...
    <div class="col-md-7">
        <h5 class="white-color-font">{{ \Illuminate\Support\Facades\Auth::guard('web')->user()->first_name. ' '. \Illuminate\Support\Facades\Auth::guard('web')->user()->last_name }}</h5>
        <span>Traveller</span>
    </div>
    <div class="col-md-12">
        <div class="col-md-12">
        ...
        <div class="col-md-12">
            <p>
                <a href="{{route('traveller.profile.show')}}" class="white-color-font">
