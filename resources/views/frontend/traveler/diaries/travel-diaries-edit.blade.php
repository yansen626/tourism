                ...
                <div class="col-md-7">
                    <div class="">
                        <div class="col-md-12 mb-md-70">
                            {{ Form::open(['route'=>['traveller.profile.diary.update', $diaries->id],'method' => 'put','id' => 'general-form','class'=>'form-horizontal form-label-left', 'enctype'=>'multipart/form-data']) }}
                            {{ csrf_field()}}
                            ...
                            <div id="trip_1" class="col-lg-12 col-md-12" style="margin-bottom: 20px;">
                                ...
                                <div class="btn-group" data-toggle="buttons" style="margin-bottom:2%;">
                                    ...
                                    <label class="btn btn-default form-check-label {{ $identity === 'YOUTUBE' ? 'active' : '' }}">
                                        <input class="form-check-input" id="id-youtube" name="identity" value="youtube" type="radio" {{ $identity === 'YOUTUBE' ? 'checked' : '' }}> Youtube
                                    </label>

                                    <label class="btn btn-default form-check-label {{ $identity === 'IMAGE' ? 'active' : '' }}">
                                        <input class="form-check-input" id="id-image" name="identity" value="image" type="radio" {{ $identity === 'IMAGE' ? 'checked' : '' }}> Image
                                    </label>

                                </div>
                                <div @if($identity === 'IMAGE' || $identity === 'none') style="display: none;" @endif class="form-group" id="form-youtube">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="youtube" type="text" class="form-control col-md-7 col-xs-12 @if($errors->has('youtube')) parsley-error @endif"
                                               name="youtube" value="{{$diaries->youtube_link}}">
                                    </div>
                                </div>
                                <div @if($identity === 'YOUTUBE' || $identity === 'none') style="display: none;" @endif class="form-group" id="form-image">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <textarea rows="8" id="description" name="description" class="form-control col-md-7 col-xs-12">{{ $diaries->description ?? '' }}</textarea>
                                    </div>
                                </div>
                            </div>
                                <div class="form-group">
