...
@section('body-content')
	...
	<section class="small-section cws_prlx_section bg-gray-40"><img src="{{ URL::asset('frontend_images/bg.jpg') }}" alt class="cws_prlx_layer">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
	...
	<section class="small-section cws_prlx_section bg-blue-40"><img src="{{ URL::asset('frontend_images/bg.jpg') }}" alt class="cws_prlx_layer">
		<div class="container">
			<div class="row">
				<div class="col-md-8">
				...
				<div class="owl-three-item">
					...
					<div class="testimonial-item">
						...
						<div class="testimonial-body">
							...
							<div class="stars stars-5"></div>
							<p class="align-center">Nulla elit justo, dapibus ut lacus ac, ornare elementum neque.</p><a href="page-about-us.html" class="testimonial-button">Visit Profile</a>
						</div>
					</div>
					<!-- testimonial item-->
					<div class="testimonial-item">
						...
						<div class="testimonial-body">
							...
							<div class="stars stars-5"></div>
							<p class="align-center">Maece facilisis sit amet mauris eget aliquam. Integer vitae.</p><a href="page-about-us.html" class="testimonial-button">Visit Profile</a>
						</div>
					</div>
					<!-- testimonial item-->
					<div class="testimonial-item">
						...
						<div class="testimonial-body">
							<h5 class="title"><span>Nicole</span> Beck</h5>
							<div class="stars stars-5"></div>
							<p class="align-center">Suspe blandit orci quis lorem eleifend maximus. Quisque nec.</p><a href="page-about-us.html" class="testimonial-button">Visit Profile</a>
						</div>
					</div>
				</div>
			</div>
