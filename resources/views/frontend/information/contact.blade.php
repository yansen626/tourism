            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="contact-item">
                        ...
                        <ul class="icon">
                            <li> <a href="#">ask@hellothisisindonesia.com<i class="flaticon-suntour-email"></i></a></li>
                            <li> <a href="#">Ask Us On Facebook<i class="fa fa-facebook-square" style="padding-top: 6px;"> </i></a></li>
                            <li> <a href="#">Join Our Community on Instagram @hellothisisindonesia <i class="fa fa-instagram" style="padding-top: 6px;"> </i> </a></li>
