                ...
                <div style="margin:3%;">
                    <div class="row">
                        ...
                        <div class="col-md-8 mb-md-70">
                            ...
                            <input type="hidden" id="service_fee" value="{{ $pricing->service_fee }}"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="quantity" name="quantity" class="form-control col-md-12" onkeyup="getTotal()" value="{{ $pricing->quantity }}" required/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <a href="{{ route('travelmate.packages.price.index', ['package' => $pricing->package_id]) }}" class="btn btn-warning">CANCEL</a>
...
@section('scripts')
    ...
    <script>
        ...
        priceFormat = new AutoNumeric('#price','{{ $pricing->price }}', {
            decimalCharacter: ',',
            digitGroupSeparator: '.',
            minimumValue: '0',
            decimalPlaces: 0
        ...
        totalPriceFormat = new AutoNumeric('#total_price','{{ $pricing->total_price }}', {
            decimalCharacter: ',',
            digitGroupSeparator: '.',
            minimumValue: '0',
            decimalPlaces: 0
        ...
        finalPriceFormat = new AutoNumeric('#final_price','{{ $pricing->getOriginal('final_price') }}', {
            decimalCharacter: ',',
            digitGroupSeparator: '.',
            minimumValue: '0',
            decimalPlaces: 0
